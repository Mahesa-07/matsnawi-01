    ...
    baitContainer.innerHTML = baits
      .map((b, i) => {
        ...
        const editMark = isEdited
          ? `<span class="edit-indicator" title="Bait ini telah diedit">teks diperbarui</span>`
          : "";

        // 🧩 ✅ HTML diizinkan khusus untuk konten teks
        ...
        // Sisanya tetap di-escape agar aman
